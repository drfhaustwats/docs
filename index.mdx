...
1. **30 MHz ParlIO**: High-speed pixel data streaming (80 MHz clock, 30 MHz effective data rate)
2. **5 Mbaud UART**: AT command protocol and firmware updates
