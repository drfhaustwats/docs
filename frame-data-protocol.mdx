...
description: "Deep dive into the 80MHz ParlIO→SPI frame protocol, 4-channel data formats, and NeoPixelBus LED control"
---
...
parlio_tx_gpio_config_t gpio_config = {
    .clk_out_pin = GPIO_NUM_10,    // 80MHz clock to ESP32 WROOM
...
Frame time:  16012 ÷ 9,000,000 = 1.78ms maximum
Typical:     800 pixels/ch = 12812 bytes = 1.42ms
```
