...
- [AT+LED_PREP](/api-reference/at-commands/led#at-led-prep) - Prepare LED frame reception (4-channel with pixel counts and formats)
...
- **Direction**: ESP32-C5 (master) → ESP32 WROOM (slave)
