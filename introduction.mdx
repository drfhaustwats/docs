...
This documentation covers the Watts v2 controller firmware architecture, designed as a high-performance dual-MCU outdoor lighting system with synchronized LED control and robust communication protocols.
...
|  • ParlIO TX 1-bit @ 40 MHz + VALID pin → pixel stream      |
...
| **Pixel Transport** | ParlIO TX, 40 MHz + VALID | ParlIO/SPI-Slave DMA RX |
...
- **40 MHz ParlIO** high-speed inter-MCU communication
...
1. **40 MHz ParlIO**: High-speed pixel data streaming
2. **921.6k UART**: AT command protocol and firmware updates
