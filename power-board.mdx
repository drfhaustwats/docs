...
**Source:** `TCA9555_Init()` in [main.c](src/power%20super/Core/Src/main.c)
...
**Source Code:**
- STM32 I2C slave: `HAL_I2C_AddrCallback()` and related callbacks in [main.c](src/power%20super/Core/Src/main.c)
- STM32 command processing: `Process_Peripheral_Command()` in [main.c](src/power%20super/Core/Src/main.c)
- ESP32 command sender: `watts_stm_send_command()` in [watts_power_board.cpp](src/Watts-ESP-IDF-C5/components/watts_power_board/watts_power_board.cpp)
...
**I2C Command Set (defined in [main.c](src/power%20super/Core/Src/main.c) - command defines):**
...
**Source Code:**
- Main loop: `main()` STANDALONE branch in [main.c](src/power%20super/Core/Src/main.c)
- OC polling: `Poll_Overcurrent()` in [main.c](src/power%20super/Core/Src/main.c)
- OC handling: `Handle_Overcurrent()` in [main.c](src/power%20super/Core/Src/main.c)
...
**Source Code:**
- STANDALONE: OC recovery defines in [main.c](src/power%20super/Core/Src/main.c)
- PERIPHERAL: `WATTS_OC_*` defines in [watts_power_board.h](src/Watts-ESP-IDF-C5/components/watts_power_board/include/watts_power_board.h)

**STM32 STANDALONE Recovery Parameters:**
```c
// Source: main.c - OC recovery defines
...
```c
// Source: watts_power_board.h - WATTS_OC_* defines
...
**Source Code:** `INA237_Init_All()` in [main.c](src/power%20super/Core/Src/main.c)

**Configuration:**
```c
// Source: main.c - INA237_Init_All()
